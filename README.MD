...
Clone os dois repositórios dentro de uma mesma pasta raiz:

bashgit clone <url-repositorio-front> front
git clone <url-repositorio-back> back_v2

Coloque o docker-compose.yml na pasta raiz (ele já está disponível no repositório do front).
Na pasta raiz, suba os containers:
...
ComponenteEndereçoBack-end (API Flask)http://localhost:5000Mockaroo (API externa)https://api.mockaroo.com / https://my.api.mockaroo.com